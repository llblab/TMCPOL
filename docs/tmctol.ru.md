...
- `Корзина_A (33,3% общего предложения)`: Базовая ликвидность — основной механизм защиты пола. Защита пола гарантируется поддержанием 33,3% циркулирующего предложения в ликвидности. Если доля Корзины_A превышает этот порог (из-за сжигания токенов, уменьшающего общее предложение, или стратегического накопления), избыточная ликвидность может быть мигрирована в другие экосистемы DEX для стимулирования арбитража и расширения экосистемы
- `Корзина_B (11,1% общего предложения)`: Обратный выкуп для разработки — стратегическое приобретение токенов. Сжигание токенов увеличивает относительную долю этой корзины в циркулирующем предложении
- `Корзина_C (11,1% общего предложения)`: Операционный капитал — ликвидное развертывание при необходимости получения Native/Foreign. Сжигание токенов увеличивает относительную долю этой корзины в циркулирующем предложении
- `Корзина_D (11,1% общего предложения)`: Стратегический резерв — дискреционное распределение управлением. Сжигание токенов увеличивает относительную долю этой корзины в циркулирующем предложении

`Распределение vs. Циркулирующая доля`: Начальные распределения по корзинам представляют фиксированные проценты от общего предложения при минте. Однако циркулирующие доли (процент текущего предложения, удерживаемый каждой корзиной) эволюционируют динамически через сжигание токенов, обратные выкупы и стратегические перераспределения. Это различие позволяет системе поддерживать гарантии защиты пола, одновременно позволяя стратегическое расширение ликвидности.
