...
1. `XYK пулы` — Классические x×y=k AMM пулы через `pallet-asset-conversion`
   ...
   - Комиссия по умолчанию 0.0% (может быть включена решением управления)
...
pub struct RouterConfig {
    ...
    pub router_fee_bps: u32,  // По умолчанию: 50 (0.5%)
...
pub trait Config: frame_system::Config {
    ...
    /// Комиссия роутера в базисных пунктах (по умолчанию: 50 = 0.5%)
    #[pallet::constant]
